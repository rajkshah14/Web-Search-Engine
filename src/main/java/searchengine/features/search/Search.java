...
import searchengine.features.query.QueryParser;
import searchengine.misc.db.DBConfig;
import searchengine.misc.db.DML;
import searchengine.model.ResultSnippet;
            ...
            try {
                ...
                if(rs != null) {
                    ...
                    while (rs.next() && i < resultSize) {
                        ...
                        String summary = ResultSnippet.createSnippetText(rs.getString("content_snap"),qp.getAllUnstemmedTerms());
